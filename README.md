...
Data Analyst with a background in physics and experience in both scientific research and business analytics. I specialize in analyzing operational and financial data to support decision-making. I use SQL, Python, Excel, and Tableau to clean data, identify trends, and build dashboards that provide clear visibility into performance, revenue, and business operations. My work combines analytical rigor with practical, decision-focused insights in real-world commercial environments.
